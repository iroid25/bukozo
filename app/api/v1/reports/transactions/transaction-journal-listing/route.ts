...
import { buildTransactionJournalListingReport } from "@/lib/reports/transaction-journal-reports";
...
export async function GET(request: NextRequest) {
  try {
    ...
    console.error("Transaction journal listing report error:", error);
    return NextResponse.json(
      {
        success: false,
        error: "Failed to generate transaction journal listing report",
