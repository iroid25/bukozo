...
import MemberDashboardLoading from "./components/MemberDashboardLoading";
...
export default function MemberDashboardPage() {
  ...
  const fetchDashboardData = useCallback(async (isRefresh = false) => {
    try {
      ...
      const response = await axios.get("/api/v1/member/dashboard");
    ...
    return (
      <div className="flex flex-col items-center justify-center min-h-[60vh] gap-4 p-6 text-center">
        ...
        <div>
          ...
          <p className="text-neutral-500 mt-2 max-w-sm mx-auto">{error || "We couldn't reach the wealth management service."}</p>
        </div>
        <Button 
