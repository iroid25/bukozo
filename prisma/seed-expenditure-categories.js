const { PrismaClient, CategoryKind } = require("@prisma/client");
...
async function upsertExpenseCategory(category, parentId) {
...
async function seedExpenditureCategories() {
...
if (require.main === module) {
  seedExpenditureCategories()
    .catch((error) => {
      console.error("Error seeding expenditure categories:", error);
      process.exit(1);
    })
    .finally(async () => {
